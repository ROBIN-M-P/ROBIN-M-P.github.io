    ...
    <div className="space-y-6 pb-20">
      <div className="bg-card/40 border border-white/5 rounded-3xl p-8 md:p-10 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 relative z-10">
          ...
          {/* PHOTO SECTION */}
          <div className="w-32 h-32 md:w-40 md:h-40 rounded-full p-1 bg-gradient-to-br from-blue-500 to-emerald-500 shrink-0">
             {/* Using your real photo here */}
             <img src="/robin.jpg" alt="Robin M P" className="w-full h-full rounded-full bg-slate-900 object-cover border-4 border-slate-900" />
          </div>
